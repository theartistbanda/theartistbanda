document.addEventListener('DOMContentLoaded', function () {
  ...
  function preloadCovers() {
    ...
    ['/assets/yourhour-cover.webp', '/assets/levelup-cover.webp', '/assets/aatmnirbhar-cover.webp', '/assets/jego-cover.webp', '/assets/earlyfoods-cover.webp'].forEach(function (src) {
      var img = new Image();
      img.src = src;
    });
  }
