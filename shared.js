...
const PORTFOLIO = {
  ...
  lead: 'Lead product designer behind enterprise AI on iOS, Android and web cutting costs 20% for around 35,000 daily users, a wellbeing app with 1M+ downloads in 22 languages, and a logo adopted as a national identity by a large number of manufacturers across India.',
  metrics: [{
    value: 40,
    suffix: '%',
  ...
  projects: [{
    ...
    year: 2024,
    title: 'LevelUp',
    kicker: 'Gamification · SaaS · iOS, Android & Web',
    tagline: 'Work that plays like a game.',
    body: 'An enterprise gamification platform serving two audiences at once: managers configure KPIs, challenges and rewards; agents live inside them as avatars, leaderboards and live wins, on native iOS and Android apps and responsive web. Daily engagement rose 40%; now the company standard.',
    stats: [['40%', 'Engagement lift'], ['35K', 'Daily users'], ['2', 'Audiences, one system'], ['3D', 'Three.js characters']],
    tags: ['Gamification', 'Enterprise SaaS', 'iOS · Android', 'Dual-audience', 'Design Systems'],
    ...
    year: 2024,
    title: 'TaskGPT',
    kicker: 'AI suite · iOS, Android & Web · 35K DAU',
    tagline: 'An AI suite that paid for itself.',
    body: 'End-to-end design on an OpenAI + PaLM 2 + LLaMA suite for around 35,000 daily operators, shipped as native iOS and Android apps and responsive web. Call handling time down 20%.',
    stats: [['20%', 'Cost saved'], ['35K', 'Daily users'], ['14', 'Countries']],
    tags: ['AI Interface', 'iOS · Android', 'Enterprise', 'Design Systems'],
    ...
    year: 2023,
    title: 'EvaluateUs',
    kicker: 'Assessment · iOS, Android & Web · TaskUs',
    tagline: 'Data-heavy evaluation, made humane.',
    body: 'UX strategy and full redesign of an enterprise assessment platform: evaluation workflows, scoring criteria and results data, across native mobile and responsive web. Accuracy and speed improved 17%.',
    stats: [['17%', 'Accuracy lift'], ['AA', 'WCAG 2.1']],
    tags: ['Enterprise UX', 'iOS · Android', 'Data-dense UI', 'Assessment'],
  ...
  career: [{
    ...
    body: ['My work spanned AI productivity, assessment platforms, gamification and design systems, shipped as native iOS and Android apps alongside responsive web for around 35,000 daily users in 14 countries. I designed for two very different audiences: frontline operators using AI during live customer conversations, and administrators configuring the systems, quality standards and experiences behind them. Every flow was designed for phone, tablet and desktop from the start, following Apple Human Interface Guidelines on iOS and Material Design on Android, rather than designed for desktop and squeezed down later.', 'TaskGPT, AI suite for customer service teams. Content generation and regeneration, writing assistance, fake detection, and a set of extensions on top. Designed for two audiences at the same time, the operator using AI inside a live customer call and the administrator setting quality standards behind them, working across OpenAI, PaLM 2 and LLaMA. Moving it behind an encrypted wall and into the flow of the call solved the privacy problem and improved performance and speed by 20% in one go. Shipped as native iOS and Android apps and responsive web, so the assistant behaves the same whether an operator is on a phone, a tablet or a desktop.', 'EvaluateUs, transforming complex hiring and training scoring, review and reporting workflows. Designed the whole thing: scoring criteria, review queues, results tables, and the reporting that came off them, built around how a reviewer actually moves through a case rather than how the rubric happens to be written down, on native iOS and Android apps and responsive web. Review queues and scoring were designed for touch and small screens first, then scaled up to tablet and desktop. Accuracy and speed improved by 17%.', 'LevelUp, gamification. A two-sided system. Managers set the KPIs and the rewards attached to them; agents meet the same system as 3D avatars and live leaderboards, built in Three.js. It was the first gamification work at TaskUs and became the standard other teams built on. Improved engagement by 40%. Designed for native iOS and Android alongside responsive web: avatars, leaderboards and rewards on a phone, KPI configuration on a desktop, one design system across all three.', 'Design system. I owned it from token architecture through to the shipped component libraries, with platform variants for iOS, Android and web so native apps and responsive web stayed consistent across 14 countries, with accessibility built in rather than bolted on afterwards. Handover to iOS, Android and web developers ran through the same system. As the only designer, the system was also the only way to scale myself.', 'AI in the workflow. Claude, Cursor, Figma Make and v0 to build several UX directions in parallel, which surfaced edge cases and let me test a mental model before a stakeholder review instead of after one. Time-to-concept down 60%.'],
    tags: ['AI Design', 'iOS & Android', 'Responsive Web', 'Generative AI Tools', 'Enterprise UX', 'Design Systems', 'Leadership'],
    current: false
  }, {
    from: '2017',
    to: '2021',
  ...
  skills: ['Behavioural UX', 'AI Interfaces', 'Generative AI Tools', 'Design Systems', 'Multi-audience Platforms', 'Data-dense Enterprise UX', 'A/B Testing', 'Experimentation', 'Cross-cultural', 'iOS & Android App Design', 'Apple HIG · Material Design', 'Responsive Web', 'Figma', 'Zeplin', 'Motion', 'Conversion Rate Optimisation', 'Team Leadership', 'Product Strategy'],
