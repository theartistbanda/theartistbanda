...
const PORTFOLIO = {
  ...
  career: [{
    ...
    body: 'Sole designer across fintech, payments and digital wellbeing. Shipped YourHour (independent product, 1M+ downloads, 70K+ reviews), the GreenBill paperless invoicing system, JEGO (UAE wellbeing platform) and EarlyFoods (UAE e-commerce).',
