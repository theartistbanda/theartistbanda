        ...
        <div style={{
          ...
          <div style={bp.isDesktop ? { gridColumn: 'span 7' } : {}}>
            ...
            <div style={{ fontSize: 15, lineHeight: 1.75, color: A.ink2, borderTop: `1px solid ${A.line}`, paddingTop: 32 }}>
              <p style={{ margin: 0 }}>I grew up watching technology evolve, promising to make lives easier. A lot of it ended up doing the opposite, with forms that run too long, menus that hide the one thing you need and apps that help and frustrate in equal measure. I thrive on closing that gap, and some of the products I have designed are now used by millions of people who write in to praise the experience.</p>
              <p style={{ marginTop: 16 }}>I believe screens are just a medium. So much of how a product feels comes from what the person is feeling, their environment, their current goal or a recent experience, and the screen comes later. That is why understanding people and their behaviour always comes first for me, whether the product is enterprise AI, a wellbeing app, an e-commerce store or a national identity mark.</p>
              <p style={{ marginTop: 16 }}>I have designed for a billion-person market in India, for a Gulf audience shaped by faith and daily ritual, and for enterprise operators across 14 countries. Each of them taught me that "intuitive" always comes with a quiet question attached, <em>intuitive for whom</em>. I believe in knowing rather than assuming, and I would rather sit alongside users and understand their lives than accept what a report says about them.</p>
              <p style={{ marginTop: 16 }}>The simplest things are the hardest to create. Ask a room full of people what a product should have and they will list dozens of features, but ask them to prune that list and it gets difficult. Minimalism inspires me, and I leave no room for unnecessary friction in my layouts: clean on the surface, and built cleanly behind the scenes.</p>
              <p style={{ marginTop: 16 }}>Away from work, my wife and I share our home in Nottingham with three cats. I water plants, tidy rooms and keep a few simple rituals, and they remind me why clarity matters as much in life as it does on the grid.</p>
            </div>
          </div>
