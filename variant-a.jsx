        ...
        <div style={{
          ...
          <div style={bp.isDesktop ? { gridColumn: 'span 7' } : {}}>
            ...
            <div style={{ fontSize: 15, lineHeight: 1.75, color: A.ink2, borderTop: `1px solid ${A.line}`, paddingTop: 32 }}>
              ...
              <p style={{ marginTop: 16 }}>Screens are just a medium. How a product feels comes from what the person is feeling, where they are, what they are trying to do and what just happened to them. The screen comes later. Understanding people and their behaviour comes first, whether the product is enterprise AI, a wellbeing app, an e-commerce store or a national identity mark.</p>
              <p style={{ marginTop: 16 }}>I have designed for a billion-person market in India, for a Gulf audience shaped by faith and daily ritual, and for enterprise operators across 14 countries. Each taught me that "intuitive" carries a quiet question, <em>intuitive for whom</em>. Knowing beats assuming, so the answer comes from sitting alongside users and understanding their lives, not from a report.</p>
              ...
              <p style={{ marginTop: 16 }}>Away from work, my wife and I share our home in Nottingham with three cats. I water plants, tidy rooms and keep a few simple rituals. They remind me why clarity matters as much in life as it does on the grid.</p>
            </div>
          </div>
