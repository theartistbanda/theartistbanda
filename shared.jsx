...
const PORTFOLIO = {
  ...
  lead:
    'Lead product designer behind AI tools cutting enterprise costs 20%, a wellbeing app with 1M+ downloads in 22 languages, and a logo adopted as a national identity by 90% of Indian manufacturers.',
  metrics: [
  ...
  projects: [
    ...
    },
    {
      ...
      body:
        'An enterprise gamification platform: 3D characters, interactive challenges and real-time leaderboards. Daily engagement rose 40%; now the company standard.',
      stats: [
        ['40%', 'Engagement lift'],
        ['35K', 'Daily users'],
  ...
  career: [
    ...
    },
    {
      ...
      body:
        'Sole designer across fintech, payments and digital wellbeing. Shipped YourHour (independent product, 1M+ downloads), the Repos Energy fuel-delivery UX, and the GreenBill paperless invoicing system.',
