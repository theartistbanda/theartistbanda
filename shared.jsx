...
const PORTFOLIO = {
  ...
  lead:
    'Lead product designer behind enterprise AI on iOS, Android and web cutting costs 20% for around 35,000 daily users, a wellbeing app with 1M+ downloads in 22 languages, and a logo adopted as a national identity by a large number of manufacturers across India.',
  metrics: [
  ...
  projects: [
    {
      ...
      body:
        'An enterprise gamification platform serving two audiences at once: managers configure KPIs, challenges and rewards; agents live inside them as avatars, leaderboards and live wins, on native iOS and Android apps and responsive web. Daily engagement rose 40%; now the company standard.',
      stats: [
        ['40%', 'Engagement lift'],
        ['35K', 'Daily users'],
    ...
    },
    {
      ...
      body:
        'End-to-end design on an OpenAI + PaLM 2 + LLaMA suite for around 35,000 daily operators, shipped as native iOS and Android apps and responsive web. Call handling time down 20%.',
      stats: [
        ['20%', 'Cost saved'],
        ['35K', 'Daily users'],
        ['14', 'Countries'],
    ...
    },
    {
      ...
      body:
        'UX strategy and full redesign of an enterprise assessment platform: evaluation workflows, scoring criteria and results data, across native mobile and responsive web. Accuracy and speed improved 17%.',
      stats: [
        ['17%', 'Accuracy lift'],
        ['AA', 'WCAG 2.1'],
      ],
